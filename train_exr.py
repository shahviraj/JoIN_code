...
def setup_training_loop_kwargs(
    ...
    datatype   = None, # The type of data: albedo, shading etc.
    ...
    args.training_set_kwargs = dnnlib.EasyDict(class_name='training.dataset.ExrFolderDataset', path=data,datatype=datatype, use_labels=True, max_size=None, xflip=False)
    ...
    if datatype is None:
        raise ValueError("datatype must be provided!")
    desc += f'-{datatype}'    
    # ------------------------------------
...
@click.option('--datatype', help='type of the data: albedo, shading etc.', type=click.Choice(['albedo', 'shading', 'specular']))
...
def main(ctx, outdir, dry_run, **config_kwargs):
    ...
    print(f'Training datatype:  {args.training_set_kwargs.datatype}')
